...
autorun.txt - список для автозапуска приложений.
moonr.apg - гофер браузер.
nc.apg - командер для запуска приложений. Открывает максимум 512 файлов в папке. 
...
OS.TRD - диск для запуска через TR-DOS
